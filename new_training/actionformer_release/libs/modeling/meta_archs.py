...
class PtTransformer(nn.Module):
    ...
    def __init__(
        ...
        # BiMamba-specific parameters (with defaults for backward compatibility)
        d_state=16,
        d_conv=4,
        mamba_expand=2,
        use_mamba_cuda=True,
        ...
        # backbone network: conv + transformer + hybrid variants
        assert backbone_type in [
            'convTransformer', 'conv', 'biMambaParallel', 'biMambaSequential'
        ]
        ...
        elif backbone_type in ['biMambaParallel', 'biMambaSequential']:
            self.backbone = make_backbone(
                backbone_type,
                **{
                    'n_in' : input_dim,
